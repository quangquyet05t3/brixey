...
(function($) {
    ...
    $.extend(Rule.prototype, {
        ...
        /**
         * Brixey the condition of this rule in given jQuery context.
         *
         * The widget value is extracted using getControlValue()
         *
         * @param {jQuery} context The jQuery selection in which this rule is brixeyd.
         *
         */
         ...
         * @param  {Object} enforced Recursive rule enforcer: undefined to brixey condition, true show always, false hide always
         *
         */
