...
if( ! function_exists( 'cs_admin_enqueue_scripts' ) ) {
  function cs_admin_enqueue_scripts() {
    ...
    wp_enqueue_style( 'font-awesome', CS_URI .'/assets/css/et-line.css', array(), '4.2.0', 'all' );
    wp_enqueue_style( 'font-awesome', CS_URI .'/assets/css/themify-icons.css', array(), '4.2.0', 'all' );
