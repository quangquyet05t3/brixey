...
class CSFramework_Option_group extends CSFramework_Options {
  ...
  public function output() {
    ...
    $acc_title   = ( isset( $this->field['accordion_title'] ) ) ? $this->field['accordion_title'] : esc_html__( 'Adding', 'brixey' );
    ...
    echo '<div class="cs-group cs-group-'. $el_class .'-adding hidden">';
      ...
      echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. __( 'Remove', 'brixey' ) .'</a></div>';
      echo '</div>';
    ...
    echo '<div class="cs-groups cs-accordion">';
      ...
      if( ! empty( $this->value ) ) {
        ...
        foreach ( $this->value as $key => $value ) {
          ...
          echo '<div class="cs-element cs-text-right cs-remove"><a href="#" class="button cs-warning-primary cs-remove-group">'. esc_html__( 'Remove', 'brixey' ) .'</a></div>';
          echo '</div>';
          echo '</div>';
