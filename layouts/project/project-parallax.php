...
if ( $project_layout ) {
	...
	$parallax_speed = $project_layout['parallax_speed'];
} else {
	$layout = '';
	$title_area_style = '';
...
<?php }
 ...
 ?>
  <div class="brxy-project-detail parallax-details">
    <div class="container">
  ...
  <?php }
   ...
   ?>
    <!-- brxy quote (style3, brxy parallax) -->
  		<div class="brxy-quote style3 brxy-parallax" data-speed="<?php echo esc_attr($parallax_speed); ?>" data-parallax="scroll" data-image-src="<?php echo esc_url( $large_image ); ?>"></div>
  <?php
    endforeach;
  }
  	if( !$hide_control ){
